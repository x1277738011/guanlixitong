...
public class BaseDao {
    /* 成员变量*/
    protected static String driver = "com.mysql.cj.jdbc.Driver";// 定义需要加载的驱动
    //protected static String url = "jdbc:mysql://localhost:3306/tsgl";// 定义要使用的数据库资源
    protected static String url = "jdbc:mysql://localhost:3306/user?"+"useSSL=false&serverTimezone=UTC";
    protected static String dbUser = "root";// 定义连接数据库的用户名
    protected static String dbPwd = "111111";// 定义连接数据库的密码
