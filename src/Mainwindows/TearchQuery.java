...
public class TearchQuery extends PublicJFrame {
    ...
    // 创建图书表栏目名称字符串
    private String[] tb_heads = { "工号 ", "姓名 ", "性别", "所属院系", "职位",
            "年龄","工资"};
    // 图书表栏目名称对应的表字段
    ...
    private DefaultTableModel model = new DefaultTableModel(
            new Object[][] {}, tb_heads);
    private String field = "tearcherno";// 设置默认的当前的查询字段
    ...
    private void cb_query_itemStateChanged(ItemEvent arg0) {
        if (arg0.getStateChange() == ItemEvent.SELECTED) {
            ...
            list = Tearchs.selecttearchList();// 调用方法，获取所有图书列表
